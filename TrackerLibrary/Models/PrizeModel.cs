namespace TrackerLibrary.Models
{
    ...
    public class PrizeModel
    {
        ...
        /// zero if it is not used. The percentage is the fraction of 1 (so 0.5 for
        /// 50%).
        /// </summary>
        ...
        public PrizeModel(string placeName, string placeNumber, string prizeAmount, string prizePercentage)
        {
            ...
            decimal prizeAmounValue = 0;
            decimal.TryParse(prizeAmount, out prizeAmounValue);
            PrizeAmount = prizeAmounValue;
